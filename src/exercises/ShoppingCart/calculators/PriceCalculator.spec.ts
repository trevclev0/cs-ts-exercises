...
import type { Customer, CustomerPriceLevel } from "../../../types/Customer";
...
describe("PriceCalculator", () => {
  ...
  ])("calculates item price with %s price level", (priceLevel: CustomerPriceLevel, originalPrice: number, expectedPrice: number) => {
    // Arrange
